    ...
    >
      ...
      >
        ...
        >
          ...
          {/* PRIMARY: Set Up GitHub Sync */}
          <button
            onClick={onSetupGitHub}
            aria-label="Set up GitHub repository integration (recommended)"
            style={{
              width: "100%",
              padding: "20px",
          ...
          >
            <div style={{ display: "flex", alignItems: "start", gap: "16px" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  Recommended — bi-directional sync with your repository
                </div>
              </div>
            </div>
          </button>

          {/* SECONDARY: Import Token File */}
          <button
          ...
          {/* STANDARD: Import Existing Figma Variables */}
          <button
        ...
        {/* Demoted actions: Try Demo and Skip as text links */}
        <div
          style={{
            marginTop: "24px",
            display: "flex",
