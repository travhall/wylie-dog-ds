    ...
    <div style={{ padding: '16px' }}>
      ...
      <div style={{ marginBottom: '16px' }}>
        ...
        <input
          type="text"
          value={config.owner}
          onChange={(e) => handleInputChange('owner', (e.target as HTMLInputElement).value)}
      ...
      <div style={{ marginBottom: '16px' }}>
        ...
        <input
          type="text"
          value={config.repo}
          onChange={(e) => handleInputChange('repo', (e.target as HTMLInputElement).value)}
      ...
      <div style={{ display: 'flex', gap: '8px', marginBottom: '16px' }}>
        <div style={{ flex: 1 }}>
          ...
          <input
            type="text"
            value={config.branch}
            onChange={(e) => handleInputChange('branch', (e.target as HTMLInputElement).value)}
            placeholder="main"
            style={{
              width: '100%',
              padding: '8px',
        ...
        <div style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) => handleInputChange('tokenPath', (e.target as HTMLInputElement).value)}
            placeholder="tokens"
            style={{
              width: '100%',
              padding: '8px',
      ...
      <div style={{ marginBottom: '16px' }}>
        ...
        <input
          ...
          onChange={(e) => handleInputChange('accessToken', (e.target as HTMLInputElement).value)}
      ...
      <div style={{ 
        ...
        <div style={{ fontSize: '11px', fontWeight: 'bold', marginBottom: '4px', color: '#0369a1' }}>
          📁 Token File Organization
        </div>
        <div style={{ fontSize: '10px', color: '#0c4a6e', lineHeight: '1.4' }}>
          Each collection will be saved as a separate file:<br/>
          <code style={{ backgroundColor: '#e0f2fe', padding: '2px 4px', borderRadius: '2px' }}>
            {config.tokenPath}/primitive.json<br/>
      ...
      <div style={{ 
        ...
        <button
          onClick={handleSave}
          disabled={loading || !config.owner || !config.repo || !config.accessToken}
          style={{
            padding: '8px 16px',
            ...
            border: 'none',
            borderRadius: '4px',
            cursor: loading || !config.owner || !config.repo || !config.accessToken ? 'not-allowed' : 'pointer',
            fontSize: '12px',
            fontWeight: 'bold'
          }}
        >
