...
export function ValidationDisplay({ validationReport, onClose }: ValidationDisplayProps) {
    ...
    <div style={{ 
      ...
      <div style={{
        ...
        <div style={{ backgroundColor: '#f3f4f6', padding: '12px', borderRadius: '6px', marginBottom: '16px' }}>
          <h3 style={{ margin: '0 0 8px 0', fontSize: '14px', fontWeight: 600 }}>📊 Statistics</h3>
            ...
            <div style={{ maxHeight: '200px', overflow: 'auto' }}>
              {errors.map((error, i) => (
                <div key={i} style={{ 
                  ...
                  <div style={{ fontWeight: 600, color: '#dc2626' }}>{error.token}</div>
            ...
            <div style={{ maxHeight: '200px', overflow: 'auto' }}>
              {warnings.map((warning, i) => (
                <div key={i} style={{ 
                  ...
                  <div style={{ fontWeight: 600, color: '#d97706' }}>{warning.token}</div>
