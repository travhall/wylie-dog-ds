...
const meta: Meta = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: "Typography system demonstrating the type scale, hierarchy, and OKLCH color integration for text elements."
      }
    }
  },
  tags: ["autodocs"],
...
export const LineHeights: Story = {
  render: () => (
    <div className="space-y-8 max-w-2xl">
      ...
      <div>
        <h4 className="text-lg font-semibold mb-2">Relaxed (leading-relaxed)</h4>
    ...
    <div className="max-w-4xl space-y-6">
      <article className="prose prose-gray max-w-none">
        ...
        <p className="lead text-xl text-gray-600">
          How OKLCH color science and modern web technologies are revolutionizing 
          the way we build consistent user interfaces.
        </p>
        
        <h2>Introduction</h2>
        <p>
          Design systems have evolved significantly over the past decade. What started 
          as simple style guides have transformed into sophisticated, token-driven 
          architectures that enable teams to build cohesive experiences at scale.
        </p>
        
        <h3>Color Revolution</h3>
        <p>
          Traditional design systems relied on RGB and HSL color spaces, which don't 
          account for human perception. OKLCH (Oklch) provides perceptually uniform 
          colors, ensuring that color relationships remain consistent across different 
        ...
        <h4>Key Benefits</h4>
        <ul>
          <li><strong>Perceptual uniformity:</strong> Colors appear equally bright to human eyes</li>
          <li><strong>Extended gamut:</strong> 30% more colors than sRGB</li>
          <li><strong>Mathematical precision:</strong> Algorithmic color generation</li>
          <li><strong>Future-ready:</strong> Aligns with emerging web standards</li>
        </ul>
        
        <h5>Implementation Details</h5>
        <p>
          Implementing OKLCH in production requires careful consideration of browser 
          support, fallback strategies, and design tool integration.
        </p>
        
        <h6>Browser Support</h6>
        <p>
          Modern browsers now support OKLCH natively, with 93% coverage as of 2024. 
          This makes OKLCH a viable choice for production applications.
        </p>
      </article>
    </div>
  ),
  ...
  render: () => (
    <div className="space-y-6">
      <div>
        ...
        <p>
          Use the <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm font-mono">useState</code> hook 
    ...
    <div className="space-y-8">
      ...
      <div>
        <p className="text-sm md:text-base lg:text-lg mb-2">
          This paragraph adapts its size based on screen size. On mobile it's smaller, 
          on tablet it's medium, and on desktop it's larger for better readability.
        </p>
        <p className="text-sm text-gray-600 font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <p className="text-sm md:text-base text-gray-700">
            Typography scales up from mobile to larger screens, ensuring readability 
            across all devices.
          </p>
        </div>
        <div>
          <h3 className="text-lg md:text-xl font-semibold mb-2">Flexible Layout</h3>
          <p className="text-sm md:text-base text-gray-700">
