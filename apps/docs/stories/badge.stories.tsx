...
const meta: Meta<typeof Badge> = {
  title: "3. Components/Data Display/Badge",
  component: Badge,
  parameters: {
    layout: "centered",
    docs: {
      description: {
        component: 'Compact status indicators and labels for displaying metadata, counts, or categorical information. **Accessibility:** Use semantic colors and consider adding visually hidden text for context when badges convey important information through color alone.'
      }
    }
  },
  tags: ["autodocs"],
...
export const AllVariants: Story = {
  parameters: {
    docs: {
      description: {
        story: 'All available badge variants for different semantic meanings and visual hierarchy.'
      }
    }
  },
  render: () => (
...
export const StatusIndicators: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Use badges to show status across different states and contexts.'
      }
    }
  },
  render: () => (
...
export const Counts: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Badges are commonly used to display counts, notifications, or quantities.'
      }
    }
  },
  render: () => (
...
export const DosDonts: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Best practices and common mistakes when using Badge components.'
      }
    }
  },
  render: () => (
      ...
      <div>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Match variant to meaning</p>
          </div>
      ...
      <div>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Variant doesn't match meaning</p>
          </div>

          <div className="space-y-2">
            <p className="text-sm font-medium mb-2">Use long text</p>
            <Badge>This is a very long badge with too much text</Badge>
            <p className="text-xs text-muted-foreground">Badges should be brief</p>
          </div>

          <div className="space-y-2">
            <p className="text-sm font-medium mb-2">Use as buttons</p>
            <Badge className="cursor-pointer">Click me</Badge>
            <p className="text-xs text-muted-foreground">Use Button component instead</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Too many reduces impact</p>
          </div>
        </div>
      </div>
    </div>
