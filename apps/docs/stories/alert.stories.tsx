...
const meta: Meta<typeof Alert> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'Alert component for displaying important messages to users. Includes support for different variants (default, destructive, warning, success) and compound components for structured content.'
      }
    }
  },
  tags: ["autodocs"],
  ...
  render: () => (
    <div className="w-[600px]">
      <Alert variant="warning">
        ...
        <AlertDescription>
          You have used 95% of your available storage space. Your account will be suspended if you exceed 100%. 
          Consider upgrading your plan or removing unused files. You can manage your storage in the account settings 
          page or contact support for assistance with data migration options.
        </AlertDescription>
      </Alert>
    </div>
  ),
