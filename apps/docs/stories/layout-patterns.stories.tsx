...
const meta: Meta = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: "Common layout patterns and page templates using the Wylie Dog Design System components."
      }
    }
  },
  tags: ["autodocs"],
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              ...
              <Badge variant="success" className="mt-1">+20.1%</Badge>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Badge variant="success" className="mt-1">+180.1%</Badge>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Badge variant="success" className="mt-1">+19%</Badge>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Badge variant="warning" className="mt-1">+201</Badge>
            </CardContent>
          </Card>
        </div>
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Your performance metrics for the last 30 days</p>
              </CardHeader>
              <CardContent>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            ...
            modern design system built on cutting-edge OKLCH color science.
          </p>
            ...
            {[
              {
                ...
                description: "40+ accessible React components built with TypeScript and Tailwind CSS.",
                icon: "🧩"
              },
              {
                title: "OKLCH Colors", 
                description: "Next-generation color science for perceptually uniform and accessible colors.",
                icon: "🎨"
              },
              {
                title: "Design Tokens",
                description: "Systematic approach to design decisions with automated token synchronization.",
                icon: "⚙️"
              }
            ].map((feature, index) => (
              <Card key={index}>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Join thousands of developers already building with Wylie Dog Design System.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-700">
                  ...
                  accessibility, and modern web technologies. Currently leading design 
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {[
                  { name: "E-commerce Redesign", description: "Complete overhaul of checkout flow", status: "Completed" },
                  { name: "Design System v2", description: "Next generation component library", status: "In Progress" },
                  { name: "Mobile App Design", description: "iOS and Android app interfaces", status: "Planning" },
                ].map((project, index) => (
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {['UI Design', 'UX Research', 'Prototyping', 'Design Systems', 'Accessibility', 'User Testing'].map((skill) => (
