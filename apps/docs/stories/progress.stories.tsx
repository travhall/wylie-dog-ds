...
const meta: Meta<typeof Progress> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'Progress component for displaying completion progress with different variants and sizes. Supports linear progress bars with smooth animations.'
      }
    }
  },
  tags: ["autodocs"],
            ...
            {currentStep === 4 && (
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-600">
                  Please review your information and click confirm to create your account.
                </p>
              </div>
            )}
  ...
  render: () => (
    <div className="w-[400px] space-y-6">
      ...
      <div>
        ...
        <Progress value={90} variant="success" />
        <div className="text-xs text-gray-500 mt-1">Almost done! 2 tasks remaining</div>
      </div>
    </div>
  ),
};
