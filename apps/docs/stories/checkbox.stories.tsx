...
const meta: Meta<typeof Checkbox> = {
  title: "3. Components/Inputs/Checkbox",
  component: Checkbox,
  parameters: { 
    layout: "centered",
    docs: {
      description: {
        component: 'Checkbox component built on Radix UI primitives with full accessibility support, keyboard navigation, and customizable styling.'
      }
    }
  },
  tags: ["autodocs"],
  ...
  render: () => (
    <div className="space-y-4">
      <div className="flex items-center space-x-2">
        ...
        <Label htmlFor="small-checkbox" size="sm">Small checkbox</Label>
      </div>
      <div className="flex items-center space-x-2">
        <Checkbox id="medium-checkbox" size="md" />
        <Label htmlFor="medium-checkbox" size="md">Medium checkbox (default)</Label>
      </div>
      <div className="flex items-center space-x-2">
        <Checkbox id="large-checkbox" size="lg" />
        <Label htmlFor="large-checkbox" size="lg">Large checkbox</Label>
      </div>
    </div>
  ),
};
...
export const States: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <h4 className="text-sm font-medium text-neutral-700">Disabled States</h4>
        <div className="flex items-center space-x-2">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Label htmlFor="error-unchecked" error>Error unchecked</Label>
        </div>
        <div className="flex items-center space-x-2">
          <Checkbox id="error-checked" error defaultChecked />
          <Label htmlFor="error-checked" error>Error checked</Label>
        </div>
      </div>
    </div>
  ),
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            <Checkbox id="terms" />
            <Label htmlFor="terms" required>Accept terms of service</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox id="privacy" />
            <Label htmlFor="privacy" required>Accept privacy policy</Label>
          </div>
          <div className="flex items-center space-x-2">
  ...
  render: () => (
    <div className="max-w-md space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-neutral-600">What topics interest you? (Select all that apply)</p>
