...
const meta: Meta<typeof ScrollArea> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: "Custom scrollable area with styled scrollbars that works consistently across platforms."
      }
    }
  },
  tags: ["autodocs"],
...
export const LongContent: Story = {
  render: () => (
    <ScrollArea className="h-[200px] w-[350px] rounded-md border p-4">
      ...
      vehicula massa ut nulla placerat, at tempor erat congue. Sed euismod 
      lorem vel consectetur bibendum. Nulla facilisi. Donec auctor, nisl eget 
      ...
      <br /><br />
      Pellentesque vehicula massa ut nulla placerat, at tempor erat congue. 
      Sed euismod lorem vel consectetur bibendum. Nulla facilisi. Donec auctor, 
      nisl eget ultricies tincidunt, nunc nisl aliquet nisl, eget aliquam nisl 
      nisl sit amet lorem. Sed auctor, nisl eget ultricies tincidunt, nunc nisl 
