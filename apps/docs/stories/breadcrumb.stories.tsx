...
const meta: Meta<typeof Breadcrumb> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'Navigation breadcrumbs showing the current page location within a navigational hierarchy. Built with semantic HTML and full accessibility support.'
      }
    }
  },
  tags: ["autodocs"],
...
export const WithIcons: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Breadcrumbs with icons for better visual hierarchy and recognition."
      }
    }
  }
};
...
export const CustomSeparator: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Custom separators can be used to match your design system's visual style."
      }
    }
  }
};
...
export const LongPath: Story = {
    ...
    <div className="w-full max-w-2xl">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href="/enterprise/solutions">Solutions</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href="/enterprise/solutions/cloud">Cloud Services</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href="/enterprise/solutions/cloud/storage">Storage</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href="/enterprise/solutions/cloud/storage/backup">Backup Solutions</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
  ...
  parameters: {
    docs: {
      description: {
        story: "Long breadcrumb paths wrap naturally on smaller screens while maintaining readability."
      }
    }
  }
};
...
export const TruncatedPath: Story = {
    ...
    <div className="w-full max-w-lg">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href="/admin/settings/security">Security</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
  ...
  parameters: {
    docs: {
      description: {
        story: "Strategic truncation keeps important context while saving space."
      }
    }
  }
};
...
export const ApplicationExamples: Story = {
  render: () => (
    <div className="space-y-8 w-full max-w-3xl">
      <div className="space-y-3">
        <h4 className="font-medium text-neutral-800">E-commerce Product Page</h4>
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink href="/">Home</BreadcrumbLink>
  ...
  parameters: {
    docs: {
      description: {
        story: "Real-world breadcrumb implementations across different application types."
      }
    }
  }
};
...
export const Accessibility: Story = {
    ...
    <div className="space-y-6 w-full max-w-2xl">
      <div className="space-y-2">
        ...
        <p className="text-sm text-neutral-600">
          Breadcrumbs use semantic HTML with proper ARIA attributes for screen readers. 
          Use Tab to navigate links and Enter to activate.
        </p>
      </div>
      
      <div className="space-y-4">
        <div>
          <p className="text-sm font-medium text-neutral-700 mb-2">With aria-label navigation</p>
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/products" aria-label="Browse all products">Products</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage aria-label="Current page: Laptops category">Laptops</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
        ...
        <div>
          <p className="text-sm font-medium text-neutral-700 mb-2">Screen reader friendly</p>
  ...
  parameters: {
    docs: {
      description: {
        story: "Demonstrates comprehensive accessibility features including ARIA labels and semantic navigation."
      }
    }
  }
};