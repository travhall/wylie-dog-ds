...
const meta: Meta<typeof HoverCard> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'Hover-triggered content cards for displaying additional information. Built on Radix UI primitives with smooth animations and flexible positioning.'
      }
    }
  },
  tags: ["autodocs"],
...
export const UserProfile: Story = {
  render: () => (
    <div className="space-y-4">
      <p className="text-sm text-neutral-600 mb-4">Hover over team member names:</p>
      ...
      <div className="space-y-2">
        <div className="flex items-center space-x-2">
          ...
          <HoverCard>
            <HoverCardTrigger asChild>
              <Button variant="link" className="p-0 h-auto">Sarah Chen</Button>
            </HoverCardTrigger>
            <HoverCardContent className="w-80">
              <div className="flex space-x-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-neutral-600">Senior Product Designer</p>
                  <p className="text-sm">
                    Leading design for our mobile experience. 5+ years in product design.
                  </p>
                  <div className="flex items-center pt-2 space-x-4">
                    <div className="flex items-center">
                      <MapPinIcon className="mr-1 h-3 w-3 opacity-70" />
                      <span className="text-xs text-neutral-500">San Francisco</span>
                    </div>
                    <div className="flex items-center">
                      <LinkIcon className="mr-1 h-3 w-3 opacity-70" />
                      <span className="text-xs text-neutral-500">@sarahchen</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <HoverCard>
            <HoverCardTrigger asChild>
              <Button variant="link" className="p-0 h-auto">Alex Rivera</Button>
            </HoverCardTrigger>
            <HoverCardContent className="w-80">
              <div className="flex space-x-4">
                <Avatar>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-neutral-600">Full Stack Engineer</p>
                  <p className="text-sm">
                    Frontend and backend development. React, Node.js, and TypeScript expert.
                  </p>
                  <div className="flex items-center pt-2 space-x-4">
                    <div className="flex items-center">
                      <MapPinIcon className="mr-1 h-3 w-3 opacity-70" />
...
export const ProductInfo: Story = {
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="p-4 border rounded-lg">
          ...
          <HoverCard>
            <HoverCardTrigger asChild>
              <Button variant="link" className="p-0 mt-2 h-auto">View specs</Button>
            </HoverCardTrigger>
            <HoverCardContent className="w-80">
              <div className="space-y-2">
                <h4 className="font-semibold">MacBook Pro 14-inch</h4>
                <div className="space-y-1 text-sm">
                  <p><span className="font-medium">Display:</span> 14.2-inch Liquid Retina XDR</p>
                  <p><span className="font-medium">Chip:</span> Apple M3 Pro or M3 Max</p>
                  <p><span className="font-medium">Memory:</span> Up to 128GB unified memory</p>
                  <p><span className="font-medium">Storage:</span> Up to 8TB SSD</p>
                  <p><span className="font-medium">Battery:</span> Up to 18 hours</p>
                </div>
              </div>
            </HoverCardContent>
          </HoverCard>
          ...
          <HoverCard>
            ...
            <HoverCardContent className="w-80">
              <div className="space-y-2">
                ...
                <div className="space-y-1 text-sm">
                  <p><span className="font-medium">Display:</span> 12.9-inch Liquid Retina XDR</p>
                  <p><span className="font-medium">Chip:</span> Apple M2</p>
                  <p><span className="font-medium">Storage:</span> Up to 2TB</p>
                  <p><span className="font-medium">Camera:</span> 12MP Ultra Wide front camera</p>
                  <p><span className="font-medium">Connectivity:</span> Wi-Fi 6E and 5G</p>
                </div>
              </div>
            </HoverCardContent>
          </HoverCard>
  ...
  parameters: {
    docs: {
      description: {
        story: "Product information cards triggered by hover for e-commerce scenarios."
      }
    }
  }
};
          ...
          <HoverCard>
            ...
            <HoverCardContent className="w-80">
              <div className="space-y-2">
                ...
                <p className="text-xs text-neutral-600">
                  Runs after every completed render, but can be optimized with dependencies.
                </p>
              </div>
            </HoverCardContent>
          </HoverCard>
          ...
          <HoverCard>
            ...
            <HoverCardContent className="w-80">
              <div className="space-y-2">
                ...
                <p className="text-sm">
                  A Hook that is usually preferable to useState when you have complex state logic.
                </p>
                <div className="text-xs bg-neutral-50 p-2 rounded">
                  <code>const [state, dispatch] = useReducer(reducer, initialState)</code>
                </div>
                <p className="text-xs text-neutral-600">
                  Accepts a reducer function and returns the current state paired with a dispatch method.
                </p>
              </div>
            </HoverCardContent>
          </HoverCard>
...
export const Accessibility: Story = {
    ...
    <div className="space-y-6 max-w-md">
      ...
      <div className="space-y-4">
        <HoverCard openDelay={100} closeDelay={100}>
          ...
          <HoverCardContent className="w-80" role="dialog" aria-labelledby="profile-title">
            <div className="space-y-2">
              ...
              <p className="text-sm">
                ...
                Currently working on design systems and developer tools.
              </p>
              <div className="flex items-center pt-2">
  ...
  parameters: {
    docs: {
      description: {
        story: "Demonstrates accessibility features including ARIA attributes and keyboard support."
      }
    }
  }
};