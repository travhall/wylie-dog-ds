...
const meta: Meta<typeof ToggleGroup> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'Toggle button groups for selecting one or multiple options. Built on Radix UI primitives with full accessibility support and keyboard navigation.'
      }
    }
  },
  tags: ["autodocs"],
...
export const Multiple: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Multiple selection mode allows several items to be selected simultaneously."
      }
    }
  }
};
...
export const Vertical: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Vertical orientation for sidebar navigation or vertical toolbars."
      }
    }
  }
};
...
export const States: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Different states including normal, selected, and disabled options."
      }
    }
  }
};
    ...
    <div className="space-y-6 max-w-lg">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <ToggleGroup type="multiple">
            <ToggleGroupItem value="free-shipping">Free Shipping</ToggleGroupItem>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <ToggleGroup type="multiple" defaultValue={["captions"]}>
            ...
            <ToggleGroupItem value="audio-description">Audio Description</ToggleGroupItem>
...
export const EditorToolbar: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Complete editor toolbar with multiple toggle groups for different functionalities."
      }
    }
  }
};
    ...
    <div className="space-y-6 max-w-md">
      <div className="space-y-2">
        ...
        <p className="text-sm text-neutral-600">
          Use Tab to navigate between groups, Arrow keys within groups, Space to toggle.
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="mt-2 space-y-1">
            <p id="bold-desc" className="text-xs text-neutral-600">Bold: Ctrl+B</p>
            <p id="italic-desc" className="text-xs text-neutral-600">Italic: Ctrl+I</p>
            <p id="underline-desc" className="text-xs text-neutral-600">Underline: Ctrl+U</p>
          </div>
        </div>
