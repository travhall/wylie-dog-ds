...
const meta: Meta<typeof Label> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'Label component provides accessible labels for form controls with support for required indicators and error states.'
      }
    }
  },
  tags: ["autodocs"],
...
export const AllSizes: Story = {
  render: () => (
    <div className="space-y-6">
      ...
      <div className="w-64 space-y-2">
        <Label size="md" htmlFor="medium-input">Medium Label (Default)</Label>
  ...
  render: () => (
    <div className="space-y-4">
      ...
      <div className="flex items-center space-x-2">
        ...
        <Label htmlFor="error-checkbox" error>This field has an error</Label>
      </div>
    </div>
  ),
};
...
export const WithSwitches: Story = {
  render: () => (
    <div className="space-y-4 w-64">
      ...
      <div className="flex items-center justify-between">
        <Label htmlFor="marketing" required>Marketing emails</Label>
        <Switch id="marketing" />
      </div>
    </div>
  ),
