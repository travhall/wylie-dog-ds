...
const meta: Meta<typeof Toggle> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'Boolean toggle button for on/off states. Built on Radix UI primitives with support for variants, sizes, and icons.'
      }
    }
  },
  tags: ["autodocs"],
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="text-sm text-neutral-600">
          Speaker: {muted ? 'Muted' : 'Active'} | Microphone: {micMuted ? 'Muted' : 'Active'}
        </div>
      </div>
    );
  },
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 border rounded-lg">
            <div className="flex items-center gap-3">
              {wifi ? <WifiIcon className="h-5 w-5" /> : <WifiOffIcon className="h-5 w-5" />}
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-neutral-600">Push notifications and alerts</div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-neutral-600">Share location data</div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-neutral-600">Usage data collection</div>
              </div>
            </div>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Toggle variant="outline" pressed>On</Toggle>
...
export const Accessibility: Story = {
    ...
    <div className="space-y-6 max-w-md">
      <div className="space-y-2">
        ...
        <p className="text-sm text-neutral-600">
          Toggle buttons support keyboard navigation, screen readers, and proper ARIA states.
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <p id="dark-mode-description" className="text-sm text-neutral-600">
        ...
        <div className="flex items-center gap-3">
          ...
          <p id="contrast-description" className="text-sm text-neutral-600">
        ...
        <div className="flex items-center gap-3">
          ...
          <p id="text-description" className="text-sm text-neutral-600">
            Increase font sizes
          </p>
        </div>
      </div>
  ...
  parameters: {
    docs: {
      description: {
        story: "Demonstrates comprehensive accessibility features including ARIA labels and descriptions."
      }
    }
  }
};