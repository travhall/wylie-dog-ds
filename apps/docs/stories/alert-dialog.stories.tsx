...
const meta: Meta<typeof AlertDialog> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'Modal confirmation dialogs for destructive or important actions. Built on Radix UI primitives with proper focus management and accessibility support.'
      }
    }
  },
  tags: ["autodocs"],
...
export const DestructiveAction: Story = {
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            all files, settings, and collaboration history. This action cannot be undone.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel asChild>
  ...
  parameters: {
    docs: {
      description: {
        story: "Confirmation dialog for destructive actions with clear consequences."
      }
    }
  }
};
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Your subscription will be cancelled immediately and you'll lose access
            to premium features. You can resubscribe at any time, but any remaining
            time on your current plan will not be refunded.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel asChild>
...
export const DataExport: Story = {
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This will create a complete backup of all your data including documents,
            settings, and user information. The export may take several minutes to
            complete. You'll receive an email when it's ready for download.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel asChild>
  ...
  parameters: {
    docs: {
      description: {
        story: "Confirmation for time-consuming operations with clear expectations."
      }
    }
  }
};
      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete all 47 items in your trash. This action
              cannot be undone and will free up 2.3 GB of storage space.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel asChild>
      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will restore all 47 items from trash to their original locations.
              Some items may be renamed if conflicts exist.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel asChild>
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                You have unsaved changes to "My Important Document". Do you want to
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to delete these 3 items? They will be moved
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will create a shared folder containing the 3 selected items.
                Recipients will be able to view and download these files.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel asChild>
...
export const Accessibility: Story = {
    ...
    <div className="space-y-6 max-w-md">
      <div className="space-y-2">
        ...
        <p className="text-sm text-neutral-600">
          Alert dialogs trap focus, support Escape key, and provide clear actions.
          Tab to navigate, Enter/Space to activate, Escape to cancel.
        </p>
      </div>
        ...
        <AlertDialogContent role="alertdialog" aria-labelledby="delete-title" aria-describedby="delete-description">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription id="delete-description">
              This action is irreversible. Your account, all data, and subscription
              will be permanently removed. You will not be able to recover this information.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel asChild>
  ...
  parameters: {
    docs: {
      description: {
        story: "Demonstrates comprehensive accessibility features including ARIA attributes and focus management."
      }
    }
  }
};