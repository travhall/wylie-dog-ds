...
const meta: Meta<typeof ContextMenu> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Right-click context menus with support for submenus, checkboxes, radio groups, and keyboard shortcuts. Built on Radix UI primitives with full accessibility support.",
      },
    },
  },
  tags: ["autodocs"],
