...
Storybook 8+ supports **play functions** - automated interaction tests that run directly in Storybook. This lets you test component behavior visually while documenting interactions.
...
Storybook 8+ introduces **portable stories** - the ability to reuse your stories as test cases in Vitest, Jest, or other test runners. This eliminates duplication between stories and tests.
