...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Color system foundation built on OKLCH color space for perceptually uniform colors. Explore the complete color palette, usage patterns, and interactive token playground.",
      },
    },
  },
  tags: ["autodocs"],
