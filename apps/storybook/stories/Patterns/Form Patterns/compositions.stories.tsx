...
const meta: Meta = {
  title: "Patterns/Form Patterns/Settings Form",
  parameters: {
    layout: "centered",
    docs: {
      description: {
        component:
          "Real-world component composition examples demonstrating complex interactions between multiple components. These patterns show how tabs, forms, switches, and other components work together in practical applications.",
      },
    },
  },
  tags: ["autodocs"],
