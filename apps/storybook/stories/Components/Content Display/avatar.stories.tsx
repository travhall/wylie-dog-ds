...
const meta: Meta<typeof Avatar> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Avatar component for displaying user profile pictures with fallback support. Includes size variants and compound components for image and fallback content.",
      },
    },
  },
  tags: ["autodocs"],
