...
<Meta title="Foundations/Design Principles/Overview" />
...
- ⌨️ Full keyboard navigation for all interactive elements
...
- 🌈 P3 wide gamut support for vibrant colors
- ✨ Thoughtful hover and focus states
- 🎭 Smooth transitions and animations
- 📐 Golden ratio spacing for visual balance
...
- ✅ Accessibility audit scores (WCAG 2.1 AA)
- ✅ Test coverage percentage (95%+)
...
- [Getting Started Guide](/story/1-introduction-getting-started--docs) - Begin using the system
- [Color System](/story/2-foundations-design-tokens-colors--all-colors) - OKLCH color science
- [Component Patterns](/story/4-patterns-compositions--docs) - Real-world examples
- [Token Usage Guide](/story/2-foundations-token-usage--docs) - Best practices
