...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Feedback", href: "/patterns/feedback" },
      { label: "Navigation", href: "/patterns/navigation" },
      { label: "Page Compositions", href: "/patterns/compositions" },
      { label: "Responsive", href: "/patterns/responsive" },
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var s=localStorage.getItem("wd-theme");var d=s==="dark"||(!s&&window.matchMedia("(prefers-color-scheme: dark)").matches);if(d)document.documentElement.classList.add("dark");}catch(e){}})();`,
          }}
        />
      </head>
      <body
