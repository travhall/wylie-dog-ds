...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-(--space-alert-dialog-content-gap) border border-(--color-dialog-border) bg-(--color-dialog-background) p-(--space-alert-dialog-content-padding) shadow-(--shadow-lg) duration-(--transition-duration-normal)",
