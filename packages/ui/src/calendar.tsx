...
const CalendarHeader = () => (
  <div className="flex items-center justify-between">
    <button className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-[var(--color-background)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-border-focus)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-[var(--color-calendar-nav-border)] bg-transparent hover:bg-[var(--color-calendar-nav-hover)] hover:text-[var(--color-calendar-nav-text-hover)] h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100">
