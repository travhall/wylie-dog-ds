...
describeA11y('Avatar', () => {
  ...
  describe('Complete Avatar Patterns', () => {
    ...
    it('handles team member list pattern', async () => {
      ...
      expect(screen.getByLabelText("John Doe's profile picture")).toBeInTheDocument()
      expect(screen.getByLabelText("Jane Smith's profile picture")).toBeInTheDocument()
      expect(screen.getByLabelText("Mike Johnson's profile picture")).toBeInTheDocument()
    })
  })
  ...
  describe('Edge Cases', () => {
    ...
    it('handles special characters in names', async () => {
      ...
      await expectToPassA11yAudit(container)
      expect(screen.getByText('JM')).toBeInTheDocument()
      expect(screen.getByLabelText("José María's profile picture")).toBeInTheDocument()
    })
  })
})
