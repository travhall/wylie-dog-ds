...
describe("Toggle", () => {
  ...
  describe("Functionality", () => {
    ...
    it("should work as uncontrolled component", () => {
      render(
        <Toggle aria-label="Toggle" defaultPressed={false}>
          Toggle
        </Toggle>
      );
      const toggle = screen.getByRole("button");
    ...
    it("should work as controlled component", () => {
      ...
      rerender(
        <Toggle aria-label="Toggle" pressed={true}>
          Toggle
        </Toggle>
      );
  ...
  describe("Styling", () => {
    ...
    it("should combine variant and size classes", () => {
      render(
        <Toggle aria-label="Toggle" variant="outline" size="lg">
          Toggle
        </Toggle>
      );
      const toggle = screen.getByRole("button");
  ...
  describe("Integration", () => {
    ...
    it("should support data attributes", () => {
      render(
        <Toggle aria-label="Toggle" data-testid="my-toggle">
          Toggle
        </Toggle>
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("should support additional HTML attributes", () => {
      render(
        <Toggle aria-label="Toggle" id="my-toggle" title="Toggle button">
          Toggle
        </Toggle>
      );
      const toggle = screen.getByRole("button");
