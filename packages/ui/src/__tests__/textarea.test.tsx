...
describe("Textarea", () => {
  ...
  describe("Functionality", () => {
    it("should render with placeholder", () => {
      render(<Textarea aria-label="Test" placeholder="Enter text here" />);
    ...
    it("should work as controlled component", () => {
      ...
      const { rerender } = render(
        <Textarea aria-label="Test" value="Initial" onChange={handleChange} />
      );
      const textarea = screen.getByRole("textbox", {
        name: "Test",
      }) as HTMLTextAreaElement;
      ...
      rerender(
        <Textarea aria-label="Test" value="Updated" onChange={handleChange} />
      );
      expect(textarea.value).toBe("Updated");
    });

    it("should work as uncontrolled component with defaultValue", () => {
      render(<Textarea aria-label="Test" defaultValue="Initial value" />);
      const textarea = screen.getByRole("textbox", {
        name: "Test",
      }) as HTMLTextAreaElement;
    ...
    it("should handle focus and blur events", () => {
      ...
      render(
        <Textarea aria-label="Test" onFocus={handleFocus} onBlur={handleBlur} />
      );
      const textarea = screen.getByRole("textbox", { name: "Test" });
    ...
    it("should handle click events", () => {
      ...
      render(<Textarea aria-label="Test" onClick={handleClick} />);
      const textarea = screen.getByRole("textbox", { name: "Test" });
    ...
    it("should work with both error and description IDs", () => {
      render(
        <div>
          ...
          <span id="review-error" role="alert">
    ...
    it("should work in a form context", () => {
      ...
      render(
        <form onSubmit={handleSubmit}>
          <Textarea aria-label="Message" name="message" defaultValue="Hello" />
  ...
  describe("Edge Cases", () => {
    it("should handle very long text input", () => {
      ...
      render(<Textarea aria-label="Test" defaultValue={longText} />);
    ...
    it("should handle multiline text input", () => {
      ...
      render(<Textarea aria-label="Test" defaultValue={multilineText} />);
    ...
    it("should handle special characters", () => {
      const specialText = '!@#$%^&*()_+-=[]{}|;:",.<>?/`~';
      render(<Textarea aria-label="Test" defaultValue={specialText} />);
    ...
    it("should handle empty errorId and descriptionId", () => {
      render(<Textarea aria-label="Test" errorId="" descriptionId="" />);
    ...
    it("should handle dynamic error state changes", () => {
      const { rerender } = render(<Textarea aria-label="Test" error={false} />);
      let textarea = screen.getByRole("textbox", { name: "Test" });
      expect(textarea).toHaveAttribute("aria-invalid", "false");
