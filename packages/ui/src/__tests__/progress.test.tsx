...
describe("Progress", () => {
  ...
  describe("Variants & Styling", () => {
    ...
    it("should apply size classes correctly", () => {
      ...
      let progress = screen.getByRole("progressbar");
      expect(progress).toHaveClass("h-(--space-progress-height)");
    ...
    it("should have rounded corners", () => {
      render(<Progress value={50} />);
      const progress = screen.getByRole("progressbar");
      expect(progress).toHaveClass("rounded-(--space-progress-radius)");
    });
    ...
    it("should have transition animation", () => {
      ...
      expect(innerDiv).toHaveClass("duration-(--duration-slow)");
