...
describe('Badge', () => {
  describe('Accessibility', () => {
    ...
    it('should pass accessibility audit with all variants', async () => {
      const variants = ['default', 'secondary', 'success', 'warning', 'destructive', 'outline'] as const;
    ...
    it('should support aria-label for icon badges', () => {
      render(
        <Badge aria-label="New item indicator">
          🆕
        </Badge>
      );
  ...
  describe('Variants', () => {
    ...
    it('should render destructive variant', () => {
      ...
      expect(badge).toHaveClass('bg-[var(--color-badge-destructive-background)]');
      expect(badge).toHaveClass('text-[var(--color-badge-destructive-text)]');
      expect(badge).toHaveClass('border-[var(--color-badge-destructive-border)]');
    });
  ...
  describe('Styling', () => {
    it('should have base styles applied', () => {
      ...
      expect(badge).toHaveClass('rounded-[var(--badge-radius)]');
    ...
    it('should merge custom className with base styles', () => {
      render(
        <Badge className="text-lg">Badge</Badge>
      );
      const badge = screen.getByText('Badge');
  ...
  describe('Edge Cases', () => {
    it('should handle very long text', () => {
      const longText = 'This is a very long badge text that might wrap depending on the container width';
    ...
    it('should handle whitespace', () => {
      render(<Badge>  </Badge>);
      const badge = screen.getByText((content, element) => element?.className.includes('inline-flex') ?? false);
      expect(badge).toBeInTheDocument();
    });
