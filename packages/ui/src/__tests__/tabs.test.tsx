...
describe('Tabs', () => {
  ...
  describe('Variants & Styling', () => {
    ...
    it('should have disabled styles', () => {
      ...
      expect(tab).toHaveClass('disabled:pointer-events-none', 'disabled:opacity-50');
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle long tab labels', () => {
      const longLabel = 'This is a very long tab label that might need truncation';
    ...
    it('should preserve state when switching tabs', async () => {
      ...
      expect(screen.getByPlaceholderText('Type here')).toHaveValue('test value');
    });
  });
});
