...
describe('Select', () => {
  ...
  describe('Functionality', () => {
    ...
    it('should show item indicator for selected item', async () => {
      ...
      await waitFor(() => {
        ...
        expect(appleOption.closest('[role="option"]')).toHaveAttribute('aria-selected', 'true');
      });
    });
  });
  ...
  describe('SelectItem Component', () => {
    ...
    it('should apply custom className to items', async () => {
      ...
      await waitFor(() => {
        ...
        expect(customItem.closest('[role="option"]')).toHaveClass('custom-item-class');
      });
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long option text', async () => {
      const user = userEvent.setup();
      const longText = 'This is a very long option text that should be truncated or wrapped appropriately';
    ...
    it('should handle special characters in values', async () => {
      ...
      await user.click(screen.getByRole('combobox'));
      await waitFor(() => expect(screen.getByText('Dashes')).toBeInTheDocument());
