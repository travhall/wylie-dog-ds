...
describe('Input', () => {
  ...
  describe('Functionality', () => {
    ...
    it('should support different input types', () => {
      ...
      types.forEach((type) => {
        const { unmount } = render(<Input aria-label={`${type} input`} type={type} />);
    ...
    it('should support controlled value', () => {
      const { rerender } = render(<Input aria-label="Email" value="test@example.com" onChange={() => {}} />);
      const input = screen.getByLabelText('Email') as HTMLInputElement;

      expect(input.value).toBe('test@example.com');

      rerender(<Input aria-label="Email" value="new@example.com" onChange={() => {}} />);
  ...
  describe('Variants & Styling', () => {
    it('should support all size variants', async () => {
      ...
      for (const size of sizes) {
        const { container, unmount } = render(<Input aria-label="Test" size={size} />);
        const results = await axe(container);
        expect(results).toHaveNoViolations();
        unmount();
      }
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle special characters', () => {
      ...
      render(<Input aria-label="Test" value={specialChars} onChange={() => {}} />);
      const input = screen.getByLabelText('Test') as HTMLInputElement;
