        ...
        {features.map((feature, index) => (
          <div key={index} className="group relative">
            <div className="glass border border-(--color-border-primary)/10 rounded-2xl p-6 transition-all duration-500 hover:border-(--color-interactive-primary)/20 hover:scale-105">
              {/* Icon */}
              <div className="mb-4 flex items-center justify-center w-12 h-12 rounded-xl glass border-(--color-border-primary)/5 shadow-sm group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                {feature.icon}
              </div>
              ...
              <div className="space-y-2">
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-(--color-text-primary) leading-tight">
                  {feature.title}
                </h3>
