...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-b-(--space-table-border-width) bg-(--color-table-footer-background) font-(--font-weight-table-footer-font-weight) [&>tr]:last:border-b-0",
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-(--space-table-header-height) text-left align-middle font-(--font-weight-table-header-font-weight) [&:has([role=checkbox])]:pr-0",
